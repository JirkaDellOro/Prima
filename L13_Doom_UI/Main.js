...
(function (L13_Doom_UI) {
    ...
    L13_Doom_UI.avatar = new ƒ.Node("Avatar");
    ...
    async function hndLoad(_event) {
        ...
        floor.mtxLocal.scale(ƒ.Vector3.ONE(L13_Doom_UI.sizeWall * L13_Doom_UI.numWalls));
        floor.getComponent(ƒ.ComponentMaterial).mtxPivot.scale(ƒ.Vector2.ONE(L13_Doom_UI.numWalls));
        ...
        L13_Doom_UI.avatar.addComponent(new ƒ.ComponentTransform());
        L13_Doom_UI.avatar.mtxLocal.translate(ƒ.Vector3.Z(10));
        L13_Doom_UI.avatar.mtxLocal.rotate(ƒ.Vector3.Y(180));
        root.appendChild(L13_Doom_UI.avatar);
        L13_Doom_UI.viewport = new ƒ.Viewport();
    ...
    async function createEnemies() {
        ...
        for (let i = 0; i < 1; i++)
            enemies.appendChild(new L13_Doom_UI.Enemy("Cacodemon" + i, ƒ.Vector3.Z(3)));
    ...
    function createWalls() {
        ...
        walls.appendChild(new L13_Doom_UI.Wall(ƒ.Vector2.ONE(3), ƒ.Vector3.Y(L13_Doom_UI.sizeWall / 2), ƒ.Vector3.ZERO(), mtrWall));
        walls.appendChild(new L13_Doom_UI.Wall(ƒ.Vector2.ONE(3), ƒ.Vector3.SCALE(new ƒ.Vector3(0.5, 1, -0.866), L13_Doom_UI.sizeWall / 2), ƒ.Vector3.Y(120), mtrWall));
        walls.appendChild(new L13_Doom_UI.Wall(ƒ.Vector2.ONE(3), ƒ.Vector3.SCALE(new ƒ.Vector3(-0.5, 1, -0.866), L13_Doom_UI.sizeWall / 2), ƒ.Vector3.Y(-120), mtrWall));
        for (let i = -L13_Doom_UI.numWalls / 2 + 0.5; i < L13_Doom_UI.numWalls / 2; i++) {
            walls.appendChild(new L13_Doom_UI.Wall(ƒ.Vector2.ONE(3), ƒ.Vector3.SCALE(new ƒ.Vector3(-L13_Doom_UI.numWalls / 2, 0.5, i), L13_Doom_UI.sizeWall), ƒ.Vector3.Y(90), mtrWall));
            // for (let i: number = -numWalls / 2 + 0.5; i < numWalls / 2; i++)
            walls.appendChild(new L13_Doom_UI.Wall(ƒ.Vector2.ONE(3), ƒ.Vector3.SCALE(new ƒ.Vector3(L13_Doom_UI.numWalls / 2, 0.5, i), L13_Doom_UI.sizeWall), ƒ.Vector3.Y(-90), mtrWall));
            // for (let i: number = -numWalls / 2 + 0.5; i < numWalls / 2; i++)
            walls.appendChild(new L13_Doom_UI.Wall(ƒ.Vector2.ONE(3), ƒ.Vector3.SCALE(new ƒ.Vector3(i, 0.5, -L13_Doom_UI.numWalls / 2), L13_Doom_UI.sizeWall), ƒ.Vector3.Y(0), mtrWall));
            // for (let i: number = -numWalls / 2 + 0.5; i < numWalls / 2; i++)
            walls.appendChild(new L13_Doom_UI.Wall(ƒ.Vector2.ONE(3), ƒ.Vector3.SCALE(new ƒ.Vector3(i, 0.5, L13_Doom_UI.numWalls / 2), L13_Doom_UI.sizeWall), ƒ.Vector3.Y(180), mtrWall));
        }
        return walls;
    }
