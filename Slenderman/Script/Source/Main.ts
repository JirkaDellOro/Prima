namespace Script {
  ...
  let cntStrafe: ƒ.Control = new ƒ.Control("ControlStrafe", 1.5, ƒ.CONTROL_TYPE.PROPORTIONAL, 500);
  ...
  function hndPointer(_event: PointerEvent): void {
    ...
    avatar.getChildrenByName("Camera")[0].mtxLocal.rotation = ƒ.Vector3.X(rotationX);
  }
}